...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "People Count SOUTH IN", endpointType.peopleCounter);
  endpoints.addEndpoint("2", "People Count SOUTH OUT", endpointType.peopleCounter);
  endpoints.addEndpoint("3", "People Count NORTH IN", endpointType.peopleCounter);
  endpoints.addEndpoint("4", "People Count NORTH OUT", endpointType.peopleCounter);
  endpoints.addEndpoint("5", "People Count EAST IN", endpointType.peopleCounter);
  endpoints.addEndpoint("6", "People Count EAST OUT", endpointType.peopleCounter);
  endpoints.addEndpoint("7", "Snapshot", endpointType.camera);
}
