...
# Parsing + Configuration Script – Artificial Vision - Rev. A

This **Parsing + Configuration** script is designed for the **Artificial Vision** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Artificial Vision Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Artificial Vision** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
